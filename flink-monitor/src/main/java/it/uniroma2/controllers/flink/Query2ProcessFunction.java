...
public class Query2ProcessFunction extends AbstractQuery<TileQ1> {
    ...
    public Query2ProcessFunction(DataStream<TileQ1> inputStream) {
        super(inputStream);
    }
    ...
    public DataStream<TileQ2> run() {
        ...
        DataStream<TileQ2> combinedTiles = subTiles
                ...
                .process(new Tuple3SubTileQ2SubTileQ2KeyedProcessFunction())
    ...
    private static class Tuple3SubTileQ2SubTileQ2KeyedProcessFunction extends KeyedProcessFunction<Tuple3<Integer, Integer, String>, SubTileQ2, SubTileQ2> {
        ...
        public void processElement(SubTileQ2 input, KeyedProcessFunction<Tuple3<Integer, Integer, String>, SubTileQ2, SubTileQ2>.Context context, Collector<SubTileQ2> collector) throws Exception {
            ...
            // System.out.printf("Key: %d, TileID: %d, LayerID %d, Depth: %d, processed: %d\n",
            //                   context.getCurrentKey().f0,
            //                   input.getTileID(), input.getLayerID(), input.getDepth(),
            //                   processed.value());
